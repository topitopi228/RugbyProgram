      ...
      try {
        const items: MediaItem[] = [
          ...
          },
          {
            ...
            url: '/media13.mp4',
            title: {
              UA: 'Тренування з силової підготовки',
              EN: 'Strength Training Session',
              HUN: 'Erőnléti edzés'
            },
            category: 'training'
          },
          ...
          },
          {
            ...
            url: '/media19.mp4',
            title: {
              UA: 'Стрибки та гра ногами',
              EN: 'Lineouts and Kicking',
              HUN: 'Bedobások és rúgások'
            },
            category: 'training'
          },
          {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-lg text-gray-300">
            {language === 'UA' ? 'Завантаження медіа...' : language === 'EN' ? 'Loading media...' : 'Média betöltése...'}
          </p>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">
            {language === 'UA' ? 'Медіа не знайдено' : language === 'EN' ? 'No media found' : 'Nincs megjeleníthető média'}
          </h2>
          <p className="text-gray-400">
            {language === 'UA' 
              ? 'На жаль, не вдалося завантажити медіафайли.' 
              : language === 'EN' 
                ? 'Could not load media files.' 
                : 'Nem sikerült betölteni a médiafájlokat.'}
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            {language === 'UA' 
              ? 'Останні відео та фото з тренувань та матчів нашої команди' 
              : language === 'EN' 
                ? 'Latest videos and photos from our team\'s training sessions and matches' 
                : 'Legfrissebb videók és képek csapatunk edzéseiről és mérkőzéseiről'}
          </p>
        </motion.div>
                ...
                >
                  {currentItem.type === 'video' ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <img
                        src={currentItem.url}
                        alt={currentItem.title[language]}
