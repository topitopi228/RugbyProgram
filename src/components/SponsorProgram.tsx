                    ...
                    <div
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-6xl mx-auto px-4">
                                ...
                                >
                                    <div
                                        className="w-8 h-8 sm:w-10 sm:h-10 bg-yellow-500/10 rounded-lg sm:rounded-xl flex items-center justify-center mb-1 sm:mb-2 group-hover:bg-yellow-500/20 transition-colors">
                                        <svg className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400" fill="none" stroke="currentColor"
                                             viewBox="0 0 24 24">
                                    ...
                                    <span className="text-[10px] sm:text-xs text-blue-100 text-center">{t.contactPhone}</span>
                                </motion.a>
                                ...
                                >
                                    ...
                                    <span className="text-[10px] sm:text-xs text-blue-100 text-center break-all line-clamp-2">{t.contactEmail}</span>
                                </motion.a>
                                ...
                                >
                                    <div
                                        className="w-8 h-8 sm:w-10 sm:h-10 bg-yellow-500/10 rounded-lg sm:rounded-xl flex items-center justify-center mb-1 sm:mb-2 group-hover:bg-yellow-500/20 transition-colors">
                                        <svg className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-400" fill="currentColor"
                                             viewBox="0 0 24 24">
                                            <path
                                    ...
                                    <span className="text-[10px] sm:text-xs text-blue-100 text-center">@{t.contactTelegram.split('/').pop()}</span>
                                </motion.a>
