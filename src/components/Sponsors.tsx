                ...
                >
                    ...
                    <div className="relative z-10">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                            ...
                            <motion.div 
                                className="relative w-full max-w-xs h-96 lg:w-96 lg:h-[500px] flex-shrink-0 flex flex-col items-center"
                                initial={{ opacity: 0, scale: 0.9 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                viewport={{ once: true }}
                                transition={{ duration: 0.6, delay: 0.2 }}
                            >
                                {/* Olympic Rings - Moved to top */}
                                <div className="relative w-full flex-1 flex items-center justify-center">
                                    ...
                                    <div className="relative w-72 h-56 flex items-center justify-center">
                                        ...
                                        <div className="absolute top-0 left-1/2 md:p-0 -translate-x-1/2 flex items-center justify-center space-x-7 md:space-x-9">
                                            {/* Blue Ring */}
                                            <motion.div
                                                className="w-20 h-20 md:w-24 md:h-24 rounded-full border-[5px] border-blue-500 shadow-lg bg-transparent"
                                            ...
                                            {/* Black Ring */}
                                            <motion.div
                                                className="w-20 h-20 md:w-24 md:h-24 rounded-full border-[5px] border-black shadow-lg bg-transparent"
                                                initial={{ scale: 0, opacity: 0, y: -20 }}
                                                animate={{ scale: 1, opacity: 1, y: 0 }}
                                            ...
                                            {/* Red Ring */}
                                            <motion.div
                                                className="w-20 h-20 md:w-24 md:h-24 rounded-full border-[5px] border-red-500 shadow-lg bg-transparent"
                                                initial={{ scale: 0, opacity: 0, y: -20 }}
                                                animate={{ scale: 1, opacity: 1, y: 0 }}
                                        ...
                                        {/* Row 2 - Bottom Rings (Yellow, Green) - Offset */}
                                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center space-x-7 md:space-x-9 mt-5">
                                            {/* Yellow Ring */}
                                            <motion.div
                                                className="w-20 h-20 md:w-24 md:h-24 rounded-full border-[5px] border-yellow-400 shadow-lg bg-transparent"
                                                initial={{ scale: 0, opacity: 0, y: 20 }}
                                                animate={{ scale: 1, opacity: 1, y: 0 }}
                                            ...
                                            {/* Green Ring */}
                                            <motion.div
                                                className="w-20 h-20 md:w-24 md:h-24 rounded-full border-[5px] border-green-500 shadow-lg bg-transparent"
                                                initial={{ scale: 0, opacity: 0, y: 20 }}
                                                animate={{ scale: 1, opacity: 1, y: 0 }}
                                ...
                                {/* U-16 Badge - Moved below rings */}
                                <motion.div
                                    className="relative w-28 h-28 md:w-36 md:mt-0 md:p-0 md:h-36 rounded-full border-4 border-yellow-400 bg-blue-900/95 backdrop-blur-sm flex items-center justify-center z-20 shadow-xl mt-[100px]"
                                ...
                                >
                                    ...
                                    <div className="relative z-10 text-center">
                                        <div className="text-yellow-400 text-3xl md:text-4xl font-bold">U-16</div>
                                ...
                                <motion.div
                                    className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 via-yellow-400 to-green-500 opacity-0 blur-2xl"
                                    animate={{
                                        opacity: [0, 0.1, 0],
                                        scale: [1, 1.2, 1]
                                    }}
